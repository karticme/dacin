...
export async function renameItem(messageId, newName) {
  return invoke("rename_item", { messageId, newName });
}

export async function deleteItem(messageId) {
  return invoke("delete_item", { messageId });
}
