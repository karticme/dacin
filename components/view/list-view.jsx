...
export default function ListView({ data }) {
  ...
  return (
    <div className="flex flex-col p-1.5">
      <div className="sticky top-0 h-8 bg-background/50 grid grid-cols-[20px_repeat(13,minmax(0,1fr))] items-center gap-3 px-3.5 -mx-1.5 -mt-1.5 backdrop-blur border-b text-xs text-muted-foreground z-10">
      ...
      {data.map((item) => (
        ...
        >
          <div
            className="group/item grid grid-cols-[20px_repeat(13,minmax(0,1fr))] items-center gap-3 px-2 py-1.5 text-[13px] rounded-sm transition-colors ease-in-out duration-600 data-selected:bg-muted data-pressed:bg-muted nth-[2]:mt-1.5"
