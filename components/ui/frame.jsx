...
export function Frame({ className, ...props }) {
  return (
    <div
      className={cn(
...
export function FramePanel({ className, ...props }) {
  return (
    <div
      className={cn(
...
export function FrameHeader({ className, ...props }) {
  return (
    <header
...
export function FrameTitle({ className, ...props }) {
  return (
    <div
...
export function FrameDescription({ className, ...props }) {
  return (
    <div
...
export function FrameFooter({ className, ...props }) {
  return (
    <footer
