...
export function ComboboxChipsInput({ className, size, ...props }) {
...
export function ComboboxTrigger({ className, children, ...props }) {
  return (
...
export function ComboboxItem({ className, children, ...props }) {
  return (
...
export function ComboboxGroupLabel({ className, ...props }) {
  return (
...
export function ComboboxRow({ className, ...props }) {
  return (
...
export function ComboboxStatus({ className, ...props }) {
  return (
...
export function ComboboxChips({ className, children, startAddon, ...props }) {
  const { chipsRef } = React.useContext(ComboboxContext);
...
export function ComboboxChip({ children, removeProps, ...props }) {
  return (
