...
export function CardFrame({ className, render, ...props }) {
  const defaultProps = {
    className: cn(
...
export function CardFrameHeader({ className, render, ...props }) {
  const defaultProps = {
    className: cn(
...
export function CardFrameTitle({ className, render, ...props }) {
  const defaultProps = {
...
export function CardFrameDescription({ className, render, ...props }) {
  const defaultProps = {
...
export function CardFrameAction({ className, render, ...props }) {
  const defaultProps = {
    className: cn(
...
export function CardFrameFooter({ className, render, ...props }) {
  const defaultProps = {
