...
export function MenuTrigger({ className, children, ...props }) {
  return (
...
export function MenuItem({ className, inset, variant = "default", ...props }) {
  return (
    <MenuPrimitive.Item
      className={cn(
...
export function MenuGroupLabel({ className, inset, ...props }) {
  return (
...
export function MenuSubTrigger({ className, inset, children, ...props }) {
  return (
